...
func main() {
	...
	cpf.HttpProfile.Endpoint = "iam-app-api.huwang.wedev.cool"
	...
	request := iam.NewDescribeAccountAuthDetailRequest()

	// 通过client对象调用想要访问的接口，需要传入请求对象
	response, err := client.DescribeAccountAuthDetail(request)

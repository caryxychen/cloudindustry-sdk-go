...
import (
	"fmt"
	"github.com/caryxychen/cloudindustry-sdk-go/client/product"
...
func main() {
	...
	request := product.NewDescribeProductPriceInfoRequest()
	request.ProductUuid = "e85c2527-524c-4210-b2ab-1d150136d093"
	request.SpecUuid = "90bf7f7f-6ef7-4ea9-9acf-df5c64960db3"
	request.TimeUnit = "y"
	request.TimeSpan = 1

	// 通过client对象调用想要访问的接口，需要传入请求对象
	response, err := client.DescribeProductPriceInfo(request)

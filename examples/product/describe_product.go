...
func main() {
	...
	request := product.NewDescribeProductRequest()
	request.ProductUuid = "003e9db2-5d5c-43b2-837e-7672cd1cfdae"
	...
	// 打印返回的json字符串
	fmt.Printf("%+v, %v", response.Response.ProductInfo, response.Response.RequestId)
}
